...
const GlobalMessage = /* html */`<div class='center' style='color:gray;font-size:23px'><i>Website migration to "<a href="javascript:void(0)">ZONEVICE.com</a>" confirmed</i></div>`;
